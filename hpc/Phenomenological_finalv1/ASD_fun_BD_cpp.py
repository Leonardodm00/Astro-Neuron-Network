...
def get_Neuronparam(**kwargs):
    ...
    'Cm':       3*pF,               # membrane capacitance C (Doorn: 1 uF/cm^2 * 300 um^2; tau_m=3.3 ms)
    ...
    'gl_ref': 0.9*nS,               # FIXED leak ref for the diffusion noise (Doorn scale; = gl so sigma_V=sigma)
    ...
    'gl':     0.9*nS,               # idx 30  leak conductance g_L (Doorn: 0.3 mS/cm^2 * 300 um^2)
